...
class SimpleSubShell ( cmd.Cmd ) :
	...
	def __working_daemon( self ) :
		while True :
			...
			if self.queue_dict['messages'].empty() :
				#print( "Waiting for Condition = working daemon method in simple sub shell" )
				self.queue_dict['condition'].wait()
				# Chunk arrived --
				#print( "Chunk arrived. Condition met - working daemon method in simple sub shell" )
	...
	def precmd( self, line ) :
		...
		line_ = line.strip()
		#print("Inside simple sub shell precmd method")
		#print( line_.startswith( self.base_shell.stream_preamp_char ) ) #uncommented print line
		#print( line[0:] ) #uncommented print line 
		# self.message_logger.info( line )
		if line_.startswith( self.base_shell.stream_preamp_char ) :
			#print("Inside simple sub shell precmd method if statement")
			try :
	...
	def updatePrompt( self ) :
		...
		#print("Inside update prompt method in simple sub shell")
