...
t = time.strftime("%d-%m-%Y_%H-%M-%S", time.gmtime())
...
subprocess.call(["cat", "/opt/Sabre-TOC/light-sabre/ls-banner.txt"])

print('')
q = input('What Color Crystal are you wanting to use (RED, BLUE, PURPLE, etc..) ? ')
print(str(q).lower())
if str(q).lower() == 'red':
	#subprocess.call(['play', '-q', 'light-saber-on.wav'])
	q = input('What Order are we Executing??? ')
	if str(q).lower() == '66':
		subprocess.call(['cat', '/opt/Sabre-TOC/light-sabre/sl-banner.txt'])
		#subprocess.call(['play', '-q', 'imperial_march.wav'])
		print('')
		...
		print('')
		subprocess.call(['cat','/opt/Sabre-TOC/light-sabre/vs-banner.txt'])
		print('')
		print('')
		print('...... Vader Breathing...... Choking Sounds....... Your Death......')
		print('')
		#subprocess.call(['play', '-q', 'swvader02.wav'])
		quit()
else:
	print('These are not the droids you are looking for.....')
	print('Jedi Scum....')
	#subprocess.call(['play', '-q', 'swvader01.wav'])
	quit()
